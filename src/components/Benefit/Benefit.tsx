...
const features = [
  {
    ...
    desc: 'Reach thousands of customers daily.',
    gradient: 'from-[#DC3173] to-[#FF6F61]',
  },
  {
    icon: <Truck className="w-10 h-10 text-white" />, 
    title: 'Hassle-free Delivery',
    desc: 'Integrated delivery system with real-time tracking.',
    gradient: 'from-[#FF6F61] to-[#FF9980]',
  },
  {
    icon: <DollarSign className="w-10 h-10 text-white" />, 
    title: 'Fast Payouts',
    desc: 'Secure and transparent payment process.',
    gradient: 'from-[#FFCC33] to-[#FFD966]',
  },
  {
    icon: <Headphones className="w-10 h-10 text-white" />, 
    title: '24/7 Support',
    desc: 'Multilingual assistance for vendors (Portuguese & English).',
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-8 lg:px-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, i) => (
            ...
            >
              <div className={`mb-4 flex items-center justify-center w-16 h-16 rounded-full bg-gradient-to-tr ${feature.gradient} shadow-lg`}>{feature.icon}</div>
