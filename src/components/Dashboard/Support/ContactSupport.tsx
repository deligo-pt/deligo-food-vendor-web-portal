      ...
      <div className="max-w-[900px] mx-auto space-y-10">
        ...
        {sent && (
          ...
          >
            ...
            <p>
              Your message has been delivered. Our support team will respond
              soon.
            </p>
          </motion.div>
        )}
        ...
        >
          <CardContent className="p-6 flex flex-col items-center text-center gap-3">
            ...
            <p className="text-sm text-gray-600 max-w-[400px]">
              Our dedicated support agents are available 7 days a week to assist
              you with orders, payouts, menu issues and system problems.
            </p>
