export const pt = {
  ...
  // hero section
  heroTitle:
    "Junte-se à plataforma de entrega de comida e mercearia que mais cresce em Portugal",
  heroSubTitle:
    "Comece a vender online em apenas alguns minutos. Gira tudo a partir de um único painel.",
  ...
  benefitFeatureDesc2:
    "Sistema de entrega integrado com rastreamento em tempo real.",
  ...
  benefitFeatureDesc4:
    "Assistência multilíngue para vendedores (Português e Inglês).",
  ...
  howItWorksStepDesc3:
    "Aceite ou confirme automaticamente os pedidos recebidos.",
  ...
  adsFeatureDesc1:
    "Alcance milhares de potenciais clientes fora da plataforma.",
  adsFeatureTitle2: "Público-Alvo",
  adsFeatureDesc2:
    "Segmente utilizadores com precisão com base na localização e comportamento.",
  adsFeatureTitle3: "Alcance Global",
  adsFeatureDesc3:
    "Expanda a visibilidade do seu negócio para além de Portugal.",
  ...
  adsCTADesc:
    "Comece a publicar anúncios pagos no DeliGo e ganhe novos clientes instantaneamente.",
  adsCTA: "Lançar Campanha de Anúncios",

  // tools -> manage products
  manageProductsHeading: "Gerir Produtos de Forma Simples",
  manageProductsDesc:
    "O DeliGo está a trazer uma forma mais inteligente para os vendedores gerirem os seus produtos — simples, visual e extremamente rápida.",
  productStepTitle1: "Adicione Produtos Facilmente",
  productStepDesc1:
    "Carregue imagens, detalhes e preços dos seus produtos em apenas alguns cliques através do nosso sistema simplificado.",
  productStepTitle2: "Edite a Qualquer Momento",
  productStepDesc2:
    "Precisa de atualizar stock, descrição ou preço? Faça-o instantaneamente — as alterações refletem-se na sua loja em segundos.",
  productStepTitle3: "Acompanhe o Desempenho dos Produtos",
  productStepDesc3:
    "Veja como os seus produtos estão a vender — mais vendidos, alertas de baixo stock e tendências num único painel.",
  productStepTitle4: "Ferramentas de Gestão Inteligentes",
  productStepDesc4:
    "Automatize atualizações repetitivas, defina horários de visibilidade e gira todo o inventário sem esforço.",
  productMockupHeading: "Gira Todos os Produtos Num Só Painel",
  productMockupDesc:
    "O próximo painel de vendedor do DeliGo permitirá ver, atualizar e organizar todos os seus produtos facilmente — sem mudar de ferramentas.",
  ...
  productBenefitTitle2:
    "Sincronização automática da visibilidade em todas as plataformas parceiras DeliGo",
  productBenefitTitle3: "Insights de desempenho e crescimento ao seu alcance",

  // privacy
  privacyHeading: "Política de Privacidade",
  privacyDesc:
    "No deliGo, damos prioridade à sua privacidade. Esta política explica como recolhemos, utilizamos e protegemos as suas informações em Portugal.",
  privacyInformationHeading: "Informações que Recolhemos",
  privacyInformationDesc:
    "Recolhemos informações pessoais fornecidas no registo, como nome, email, telefone, morada, dados de pagamento e informações comerciais no caso de vendedores.",
  ...
  privacyWeUseInfoList3:
    "Enviar promoções e atualizações se houver consentimento.",
  privacyWeUseInfoList4: "Garantir conformidade com a legislação portuguesa.",
  privacyWeUseInfoList5:
    "Analisar tendências para otimizar entregas e desempenho dos vendedores.",
  privacyCookiesHeading: "Cookies e Rastreamento",
  privacyCookiesDesc:
    "Utilizamos cookies para melhorar a experiência, memorizar preferências e personalizar promoções.",
  privacyRightsHeading: "Os Seus Direitos ao Abrigo do RGPD",
  privacyRightsDesc:
    "Como empresa sediada na UE, o deliGo garante todos os direitos previstos no RGPD:",
  privacyRightsList1:
    "Direito de acesso, correção ou eliminação dos seus dados.",
  privacyRightsList2:
    "Direito de retirar consentimento de comunicações de marketing.",
  ...
  privacyPaymentsDesc:
    "Todos os pagamentos são processados através de gateways seguros como Stripe e PayPal.",
  privacyDeliveryHeading: "Dados de Entrega e Localização",
  privacyDeliveryDesc:
    "Recolhemos moradas e dados de localização apenas para fins operacionais.",
  privacySecurityHeading: "Medidas de Segurança",
  privacySecurityDesc:
    "Utilizamos encriptação, servidores seguros e auditorias regulares.",
  privacyContactHeading: "Questões sobre os seus dados?",
  privacyContactDesc:
    "A nossa equipa de suporte em Portugal está disponível para ajudar.",
  ...
  termsDesc:
    "Ao aderir ao Deligo como vendedor, concorda com os seguintes termos.",
  termsSectionTitle1: "Registo e Conta do Vendedor",
  termsSectionDesc1:
    "Para aderir ao Deligo, deve criar uma conta com informações comerciais válidas em Portugal.",
  termsSectionTitle2: "Conformidade Legal",
  termsSectionDesc2:
    "Os vendedores devem cumprir todas as leis portuguesas aplicáveis.",
  ...
  termsSectionDesc4:
    "Os vendedores devem garantir qualidade e informações corretas.",
  ...
  termsSectionDesc6:
    "Os conflitos serão resolvidos de forma amigável sempre que possível.",
  ...
  cookieDesc:
    "Saiba como o Deligo utiliza cookies para melhorar a sua experiência.",
  ...
  cookieSecDesc2:
    "Cookies são pequenos ficheiros que melhoram a experiência do utilizador.",
  ...
  securityDesc:
    "Medidas de segurança avançadas para vendedores e clientes em todo o Portugal.",
  ...
  securityCTADesc:
    "A nossa equipa monitoriza e atualiza continuamente as medidas de segurança para proteger o seu negócio.",
  securityCTA: "Contactar Equipa de Segurança",
  vendorFeaturesTitle1: "Encriptação de Dados",
  vendorFeaturesDesc1:
    "Todos os dados dos vendedores são protegidos com métodos avançados de encriptação para evitar acessos não autorizados.",
  vendorFeaturesTitle2: "Autenticação de Dois Fatores",
  vendorFeaturesDesc2:
    "Proteja a sua conta com 2FA e alertas de login para segurança total.",
  vendorFeaturesTitle3: "Monitorização de Fraude",
  vendorFeaturesDesc3:
    "Deteção automática de atividades suspeitas para proteger o seu negócio e ganhos.",
  customerFeaturesTitle1: "Pagamentos Seguros",
  customerFeaturesDesc1:
    "Checkout seguro com processamento de pagamentos compatível com PCI e verificação instantânea.",
  customerFeaturesTitle2: "Proteção de Privacidade",
  customerFeaturesDesc2:
    "As suas informações pessoais são encriptadas e tratadas em total conformidade com o RGPD.",
  customerFeaturesTitle3: "Plataforma de Confiança",
  customerFeaturesDesc3:
    "O Deligo garante um ambiente seguro para todas as transações e interações.",
  ...
  deligo: "DeliGo",
  aboutDesc2:
    "— uma empresa tecnológica portuguesa que está a reinventar a forma como as pessoas se deslocam, comem e vivem. Desde",
  deligoRide: "DeliGo Ride",
  ourRideSharing: ", a nossa plataforma de ride-sharing, até",
  deligoDelivery: "DeliGo Delivery",
  ourFoodGrocery:
    ", a nossa rede de comida e mercearia — ligamos pessoas, motoristas e negócios locais através de tecnologia que torna o dia a dia mais simples.",
  ...
  deligoSmarterDesc:
    "Precisa de chegar rapidamente a algum lugar? O DeliGo Ride leva-o até lá. Ligamos passageiros a motoristas TVDE licenciados através de uma aplicação simples e intuitiva — oferecendo viagens seguras, confortáveis e acessíveis em todo o país.",
  deligoSmarterDesc2:
    "Também cuidamos do planeta. A nossa frota em crescimento inclui veículos elétricos e híbridos, ajudando a tornar as cidades mais verdes e limpas.",
  ...
  aboutFeatureDesc2:
    "Motoristas treinados e verificados garantem viagens seguras.",
  ...
  aboutFeatureDesc4:
    "Pague facilmente com Cartão ou MB Way — sem complicações.",
  aboutFeatureTitle5: "Frota ecológica",
  aboutFeatureDesc5:
    "Veículos elétricos e híbridos para um planeta mais limpo.",
  aboutFeatureTitle6: "Serviço fiável",
  aboutFeatureDesc6:
    "Para onde quer que vá — levamo-lo em segurança e a horas.",
  ourVisionHeading: "DeliGo Delivery — Comer, Comprar e Receber Rápido",
  ourVisionDesc:
    "Com vontade de comer algo especial ou precisa de compras urgentes? O DeliGo Delivery leva tudo até si — refeições, mercearias e bens essenciais.",
  ourVisionDesc2:
    "Trabalhamos com restaurantes locais, supermercados e lojas para oferecer aos clientes o que precisam, quando precisam.",
  ...
  deligoElectronicsDesc:
    "Inteligente. Elegante. Fiável. Os Acessórios Eletrónicos DeliGo combinam inovação tecnológica com design moderno e durável, pensados para estilos de vida atuais.",
  deligoElectronicsDesc2:
    "A nossa missão: tornar a tecnologia mais simples, rápida e inteligente para todos.",
  electronicsList1:
    "🔋 Carregadores Inteligentes e Power Banks — rápidos, seguros e duradouros.",
  electronicsList2:
    "🔌 Cabos e Adaptadores — construção premium e alto desempenho.",
  ...
  electronicsList5:
    "💻 Acessórios para Portáteis e Desktops — aumente a produtividade em qualquer lugar.",
  deligoElectronicsDesc3:
    "Não estamos apenas a entregar — estamos a ligar comunidades e a impulsionar o progresso.",
  ourPromise: "A Nossa Visão e Compromisso",
  ourPromiseDesc:
    "Tornar cada cidade mais inteligente, limpa e conectada — com tecnologia pensada para as pessoas e para o planeta.",
  ourPromiseDes2:
    "Estamos a construir um futuro onde mobilidade e entregas são simples, ecológicas, inclusivas e orgulhosamente portuguesas.",

  // help center
  helpCenter: "Centro de Ajuda",
  helpCenterDesc:
    "Tudo o que precisa de saber para vender no Deligo com sucesso. Guias, dicas e suporte detalhado ao seu alcance.",
  ...
  optimizeMenuDesc:
    "Fotos de alta qualidade, preços corretos e descrições claras aumentam as encomendas.",
  fastOrder: "Processamento Rápido de Encomendas",
  fastOrderDesc:
    "Aceite ou confirme automaticamente as encomendas rapidamente para manter uma elevada satisfação dos clientes.",
  leveragePromotions: "Aproveite Promoções",
  leverageDesc:
    "Utilize descontos, bundles e promoções para aumentar as vendas nas horas de maior movimento.",
  monitorAnalytics: "Monitorize as Métricas",
  monitorDesc:
    "Acompanhe as encomendas diárias, os produtos mais vendidos e o feedback dos clientes para melhorar o desempenho.",
  maintainCustomer: "Manter o Suporte ao Cliente",
  maintainCustomerDesc:
    "Responda rapidamente às questões dos clientes através de chat ao vivo, email ou telefone.",
  ecoFriendlyPractises: "Práticas Ecológicas",
  ecoFriendlyDesc:
    "Utilize embalagens sustentáveis e forneça produtos de origem local para atrair clientes conscientes.",
  stillHaveQuestions: "Ainda tem dúvidas?",
  haveQuestionsDesc:
    "Contacte a nossa equipa de suporte a vendedores através do canal que preferir.",
  categoriesTitle1: "Primeiros Passos",
  categoriesDesc1:
    "Aprenda como configurar rapidamente a sua conta de vendedor, verificar documentos e começar a vender no Deligo.",
  categoriesTitle2: "Encomendas e Pagamentos",
  categoriesDesc2:
    "Gira encomendas recebidas, acompanhe entregas e receba pagamentos de forma segura via SEPA.",
  categoriesTitle3: "Promoções e Marketing",
  categoriesDesc3:
    "Descubra como criar promoções, aumentar as vendas e alcançar mais clientes.",
  categoriesTitle4: "Gestão de Conta",
  categoriesDesc4:
    "Atualize o seu perfil, gere várias localizações e ajuste o seu menu ou produtos.",
  helpFaqQues1: "Que documentos são necessários para se tornar vendedor?",
  helpFaqAns1:
    "Para se juntar ao Deligo como vendedor, precisa de uma licença comercial válida, comprovativo de morada e uma conta bancária. Se for um restaurante, também é necessária licença alimentar.",
  helpFaqQues2: "Quanto tempo demora a aprovação?",
  helpFaqAns2:
    "A aprovação demora normalmente 1 a 3 dias úteis após a submissão dos documentos necessários. Receberá uma confirmação por email assim que a sua conta for aprovada.",
  helpFaqQues3: "Quando recebo os pagamentos?",
  helpFaqAns3:
    "Os pagamentos são processados diariamente para encomendas concluídas e refletem-se na sua conta bancária dentro de 24 horas.",
  helpFaqQues4: "Posso gerir várias localizações?",
  helpFaqAns4:
    "Sim! O Deligo permite gerir várias localizações de negócio a partir de um único painel. Pode adicionar ou remover localizações a qualquer momento.",
  helpFaqQues5: "Como posso promover os meus produtos?",
  helpFaqAns5:
    "Utilize a funcionalidade de Promoções para criar descontos, bundles ou ofertas especiais. Pode acompanhar o desempenho com análises em tempo real.",
  helpFaqQues6: "Que tipo de suporte está disponível?",
  helpFaqAns6:
    "A nossa equipa de suporte está disponível 24/7 através de WhatsApp, Email e Chat ao Vivo para ajudar com qualquer questão.",

  // careers
  careersHeader: "Construa o Seu Futuro com a",
  careersHeaderDeligo: "Deligo",
  careersDesc:
    "O Deligo não é apenas uma plataforma — é uma revolução na conveniência. Unimos tecnologia, pessoas e paixão para tornar o dia a dia mais inteligente, rápido e simples.",
  whyWork: "Porquê Trabalhar na Deligo?",
  whyWorkDesc:
    "Juntar-se ao Deligo é fazer parte de uma equipa movida pela inovação e centrada nas pessoas. Seja na entrega de comida, no apoio a negócios locais ou na mobilidade — terá um papel na construção do futuro do quick commerce.",
  valuesTitle1: "Cultura Colaborativa",
  valuesDesc1:
    "No Deligo, o trabalho em equipa é essencial. De parceiros de entrega a programadores, todas as vozes contam. Prosperamos na colaboração e inovação.",
  valuesTitle2: "Crescimento Profissional",
  valuesDesc2:
    "Acreditamos no crescimento contínuo. Seja em tecnologia, logística ou suporte — o Deligo dá-lhe a plataforma para aprender, liderar e evoluir mais rápido.",
  valuesTitle3: "Impacto Positivo",
  valuesDesc3:
    "Faça parte de uma missão que liga pessoas e simplifica vidas. Da comida às viagens, irá integrar um movimento que impacta milhões todos os dias.",
  valuesTitle4: "Reconhecimento e Recompensas",
  valuesDesc4:
    "Valorizamos a paixão e dedicação. No Deligo, o seu esforço é reconhecido — não só com palavras, mas com oportunidades reais.",
  lifeAtDeligo: "Vida na Deligo",
  lifeAtDeligoDesc:
    "Acreditamos que o trabalho deve ser mais do que um emprego. Deve ser significativo, inspirador e divertido. No Deligo encontrará uma cultura flexível, ferramentas modernas, mentes criativas e oportunidades constantes de aprendizagem.",
  careersFeatureTitle1: "Inovação Todos os Dias",
  careersFeatureDesc1:
    "Adoramos experimentar, construir e ultrapassar limites.",
  careersFeatureTitle2: "Pessoas em Primeiro Lugar",
  careersFeatureDesc2:
    "Cuidamos profundamente da nossa equipa, parceiros e utilizadores.",
  ...
  careersCTADesc:
    "Estamos a redefinir a experiência de quick commerce — ligando pessoas, tecnologia e negócios locais numa só plataforma. Junte-se ao Deligo e ajude-nos a entregar o futuro, mais rápido.",
  careersCTA: "Junte-se ao Movimento",

  // press & media
  pressHeading: "Deligo na Imprensa",
  pressDesc:
    "Descubra como o Deligo está a moldar o futuro do quick commerce — ligando cidades, pessoas e negócios.",
  journeyHeadlines: "A Nossa Jornada em Destaque",
  highlightsTitle1: "Startup de Quick Commerce com Crescimento Mais Rápido",
  highlightsDesc1:
    "O Deligo está a redefinir a conveniência — desde entregas de comida a mobilidade e bens essenciais do dia a dia.",
  highlightsTitle2: "Expansão em Novas Regiões",
  highlightsDesc2:
    "A nossa rede logística inteligente liga cidades e clientes com tecnologia fluida e eficiente.",
  highlightsTitle3: "A Capacitar Negócios Locais",
  highlightsDesc3:
    "O Deligo ajuda lojas locais, restaurantes e motoristas a crescer de forma digital e eficiente.",

  pressMedia: "Recursos de Imprensa e Media",
  mediaDesc:
    "Para pedidos de imprensa, entrevistas ou materiais de marca — contacte a nossa equipa de comunicação. Respondemos no prazo de 24 horas.",
  ...
  vendorRegistrationDesc:
    "Siga estes passos simples para se tornar um vendedor verificado",
  vendorRegistrationProcess: "Processo de Registo de Vendedor",
  vendorRegistrationProcessDesc:
    "Siga estes passos simples para se tornar um vendedor verificado",
  ...
  agreement: "Acordo",
  vendor_agreement: "Acordo de Fornecedor",
  ...
  id_proof_back: "Verso do comprovante de identidade",
  ...
  monthly_machine_rental_cost: "Arrendamento mensal da máquina com um custo semanal de 2,5€ (sem IVA incluído).",
  ...
  submissionProgressDesc:
    "Não submeteu os seus dados de registo. Para concluir o processo, clique no botão abaixo.",
  ...
  reviewInProgressDesc2:
    "assim que o processo de verificação estiver concluído.",
  ...
  nextStepDesc2:
    "e terá acesso ao painel do vendedor, gestão da loja e pagamentos.",
  ...
  manage_orders_in_kitchen:
    "Gerir pedidos atualmente na cozinha — progresso, atribuir estafetas e marcar como prontos.",
  details: "Detalhes",
  ...
  track_your_live_orders:
    "Acompanhe os seus pedidos em tempo real — localização do estafeta, ETA e estado da entrega.",
  ...
  manage_your_restaurants_food_delivery_items:
    "Gerir o catálogo de entregas do seu restaurante",
  filters: "Filtros",
  ...
  the_delivery_charge_will_be: "a taxa de entrega será",
  if_your_location_is: "Se a sua localização for",
  outside_of_lisbon: "fora de Lisboa",
  purchase: "Comprar",
  // --> ingedients details
  back_to_ingredients: "Voltar para Ingredientes",
  ingredients_details: "Detalhes do Ingrediente",
  review_physical_inventor_allocations: "Revise alocações de estoque físico, descontos por nível e atenda às necessidades de reposição.",
  sku_code: "Código SKU",
  shelf_life: "Validade",
  days: "Dias",
  volume_bulk_discount_schemes: "Esquemas de Desconto por Volume em Lote",
  active_tier_applied: " Nível Ativo Aplicado",
  available_dot: "● Disponível",
  out_of_stock_suspended: "● Esgotado / Suspenso",
  inventory_real_time_status: "Status do Estoque em Tempo Real",
  current_status: "Status Atual",
  stock_remaining: "Estoque Restante",
  bulk_discount_offer: "Oferta de Desconto em Lote",
  get_items_as_low_as: "Obtenha itens a partir de",
  per_unit_by_increasing_your_order_quantities: "por unidade ao aumentar a quantidade do pedido para atingir os limites de desconto.",
  no_wholesale_bulk_discount_rates: "Nenhuma taxa de desconto de atacado em lote está associada a este perfil de item no momento.",
  order_target_quantity: "Quantidade Alvo do Pedido",
  minimum_order_quantity: "Quantidade Mínima do Pedido",
  maximum_order_quantity: "Quantidade Máxima do Pedido",
  subtotal_value: "Valor do Subtotal",
  excludes: "Exclui",
  tax_profile: "Perfil Fiscal",
  buy_now: "Comprar Agora",
  unavailable: "Indisponível",
  fleet_logistics_distribution: "Distribuição Logística de Frota",
  standard_bulk_supply_lines_arrive: "Linhas de abastecimento padrão em lote chegam dentro de 2 a 3 janelas operacionais. Rastreamento ativado pelo painel do sistema de rotas de envio.",

  // my ingredient orders
  track_status_of_ingredient_purchases: "Acompanhe o status das suas compras de ingredientes",
  placed_on: "Realizado em",
  more_items: "mais item(ns)",
  no_orders_yet: "Nenhum pedido ainda",
  start_ordering_ingredients: "Comece a pedir ingredientes para vê-los aqui.",

  // ingredients details
  shipped: "Enviado",
  confirmed: "Confirmado",
  back_to_my_ingredient_orders: "Voltar para Meus Pedidos de Ingredientes",
  items_ordered: "Itens Pedidos",
  sku: "SKU",
  market_source: "Origem do Mercado",
  current_stock_pool: "Reserva de Estoque Atual",
  bulk_volume_tier_triggered: "Nível de Volume em Lote Ativado",
  includes: "Inclui",
  vat: "IVA",
  logistics_handling: "Logística e Manuseio",
  delivered_successfully_on: "Entregue com sucesso em",
  estimated_fulfillment_cycle_completes: "Ciclo estimado de processamento concluído em",
  operating_days: "dias úteis",
  shipping_destination: "Destino do Envio",
  order_financial_matrix: "Matriz Financeira do Pedido",
  products_net_base: "Base Líquida de Produtos",
  bulk_wholesale_adjustment: "Ajuste de Atacado em Lote",
  total_tax_amount: "Valor Total de Impostos",
  distribution_logistics_fee: "Taxa de Logística de Distribuição",
  grand_total: "Total Geral",
  method: "Método",
  need_assistance: "Precisa de Ajuda?",
  reference_order_id: "ID de Referência do Pedido",
  for_immediate_pipeline_routing_checkups: "para verificações imediatas do roteamento de envio.",
  contact_support_lines: "Entrar em Contato com o Suporte",
  ...
  automatic_weekly_payout:
    "Pagamento automático semanal via SEPA todas as segundas-feiras.",
  iva_handled_per_portuguese_tax:
    "IVA tratado de acordo com as regras fiscais portuguesas e já aplicado quando necessário.",
  minimum_payout_threshold: "Valor mínimo de pagamento:",
  euro_20: "€20.",
  balances_below_roll_next_cycle:
    "Saldos inferiores serão transferidos para o próximo ciclo.",
  typical_bank_transfer_time: "Tempo típico de transferência bancária:",
  hours_24_48: "24–48 horas",
  instant_payouts_fees_may_apply:
    "Para pagamentos instantâneos (se ativados), podem aplicar-se taxas — ver Definições Financeiras.",
  payouts_sent_to_registered_iban:
  ...
  configure_bank_account_payout_method_security:
    "Configurar conta bancária, método de pagamento e segurança",
  ...
  monthly: "Mensal",
  payments_follow_sepa_rules:
    "Os pagamentos seguem as regras SEPA em Portugal.",
  ...
  upload_document_for_payout_security_verification:
    "Carregue um documento para verificação de segurança dos pagamentos.",
  submit: "Submeter",
  ...
  iban_must_be_a_valid_portuguese_or_eu_bank_account:
    "O IBAN deve ser uma conta bancária válida em Portugal ou na UE.",
  minimum_payout_threshold_euro_20: "Valor mínimo de pagamento: €20.",
  identity_verification_required_for_bank_changes:
    "É necessária verificação de identidade para alterações bancárias.",
  ...
  positive_values_revenue_from_orders:
    "Valores positivos = receita proveniente de pedidos",
  negative_values_fees_adjustments_refunds:
    "Valores negativos = taxas, ajustes ou reembolsos",
  weekly_sepa_cycle_portugal:
    "Os pagamentos seguem o ciclo semanal SEPA em Portugal",
  refunds_may_take_24_48_hours:
  ...
  real_feedback_from_your_customers: "Feedback real dos seus clientes",
  ...
  neutral_reviews: "Avaliações Neutras",
  negative_reviews: "Avaliações Negativas",
  star_distribution: "Distribuição por Estrelas",
  awaiting_reviews: "Aguardando avaliações",
  ...
  tomatoes_mozzarella_cheese: "Tomates e queijo mozzarella devem esgotar hoje.",
  ...
  offer_title_20_perc_off: "Título da Oferta (ex.: 20% OFF em Hambúrgueres)",
  ...
  search_staff_by_name_or_role: "Pesquisar colaboradores por nome ou função...",
  ...
  // sales-report page
  detailed_revenue_performance: "Análises detalhadas de receita e desempenho",
  from: "De",
  to: "Até",
  ...
  net_payout_after_taxes: "Pagamento Líquido Após Impostos",
  ...
  vendor_collects_revenue: "O vendedor recolhe a receita e paga",
  iva_6_perc: "IVA de 6%",
  on_food_sales: "sobre as vendas de alimentos.",
  platform_commission_has: "A comissão da plataforma tem o seu próprio",
  ...
  no_notifications_available: "Nenhuma notificação disponível.",
  ...
  re_enter_new_password: "Reintroduza a nova palavra-passe",
  update_password: "Atualizar Palavra-passe",

  // theme settings page
  theme_settings_advanced: "Definições de Tema — Avançado",
  ...
  choose: "Escolher",
  standard_balanced_cards: "Padrão — Cartões e espaçamento equilibrados",
  compact_denser_info:
    "Compacto — Informação mais densa (mais itens por vista)",
  split_view_multi_column: "Vista Dividida — Painel multi-coluna",
  branding: "Branding",
  ...
  no_cover: "Sem capa",
  upload: "Carregar",
  dashboard_background: "Fundo do Painel",
  none: "Nenhum",
  ...
  search_for_help: "Pesquisar ajuda…",
  vendor_guidebook: "Guia do Vendedor",
  learn_how_to_use_deligo: "Aprenda a utilizar o Deligo como um profissional.",
  policies_and_safety: "Políticas e Segurança",
  rules_for_safe_platform: "Regras para uma utilização segura da plataforma.",
  ...
  faq_q_1: "Como posso gerir os meus pedidos?",
  faq_a_1:
  ...
  describe_the_issue: "Descrever o Problema",
  write_detailed_description: "Escreva uma descrição detalhada do problema…",
  ...
  need_immediate_support: "Precisa de Suporte Imediato?",
  ...
  call_us: "Ligue-nos",
  mon_sun_9am_10pm: "Seg–Dom · 9h – 22h",
  auto_response_24_7: "Resposta automática 24/7",
  instant_support: "Suporte imediato",
  start_chat: "Iniciar Chat",
  send_us_message: "Enviar-nos uma Mensagem",
  your_name: "O Seu Nome",
  enter_your_name: "Introduza o seu nome",
  enter_your_email: "Introduza o seu email",
  message: "Mensagem",
  describe_issue_question: "Descreva o seu problema ou questão…",
  send_message: "Enviar Mensagem",
  support_availability: "Disponibilidade de Suporte",
  ...
  response_time: "Tempo de resposta: 2–30 minutos",
  deligo_portugal_office: "Escritório Deligo Portugal",
  portugal: "Portugal",

  // safety guidelines page
  safety_compliance: "Segurança e Conformidade",
  ...
  hygine_rating: "Classificação de Higiene",
  food_handling_policies: "Políticas de Manuseamento Alimentar",
  store_food_items_correct_temperatures:
    "Armazenar alimentos às temperaturas corretas",
  use_sealed_containers: "Utilizar recipientes selados para entregas",
  follow_portugal_haccp_guidelines: "Cumprir as diretrizes HACCP em Portugal",
  keep_work_surfaces_sanitized:
    "Manter as superfícies de trabalho higienizadas regularmente",
  staff_safety_training: "Formação de Segurança da Equipa",
  ...
  maintain_clean_uniform: "Manter uma aparência limpa e uniforme",
  data_privacy_security: "Privacidade e Segurança de Dados",
  customer_data_must_shared: "Os dados dos clientes NÃO devem ser partilhados",
  ...
  delivery_safety: "Segurança na Entrega",
  verify_rider_identity: "Verificar a identidade do estafeta antes da entrega",
  ensure_package_sealed: "Garantir que a embalagem está devidamente selada",
  use_tamper_proof_bags: "Utilizar sacos invioláveis",
  check_correct_rider_assignment: "Confirmar a atribuição correta do estafeta",
  need_help_safety_compliance: "Precisa de ajuda com segurança e conformidade?",
  ...
  contact_safety_support: "Contactar Suporte de Segurança",
  ...
  store_photo: "Fotografia da Loja",
  ...
  // copiar produtos para filiais
  select: "Selecionar",
  clear: "Limpar",
  branches: "Filiais",
  select_all: "Selecionar tudo",
  deselect_all: "Desselecionar tudo",
  select_items_to_copy: "Selecione itens para copiar para uma filial",
  select_all_products: "Todos os produtos",
  all_products_in_catalogue: "todo o seu catálogo",
  all_products_will_be_copied: "Todos os produtos do seu catálogo",
  products_selected: "produtos selecionados",
  copying_products: "A copiar produtos...",
  approved_branches: "filiais aprovadas",
  no_approved_branches: "Nenhuma das suas filiais está aprovada",
  branch_not_approved: "Ainda não pode receber produtos",
