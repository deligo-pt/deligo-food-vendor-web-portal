  ...
  return (
    <section className="bg-linear-to-b from-[#FFE7F0] to-[#FFF5F8] py-24 px-6 sm:px-10 lg:px-20">
      ...
      >
        ...
        <p className="text-gray-700 text-lg">{t("privacyDesc")}</p>
      </motion.div>
      ...
      <div className="max-w-6xl mx-auto grid gap-12">
        ...
        <motion.div
          ...
          transition={{ duration: 0.8 }}
        >
          <h2 className="text-2xl font-bold text-[#DC3173] mb-4">
            {t("privacyInformationHeading")}
          </h2>
      ...
      >
        ...
        <p className="text-gray-700 mb-8">{t("privacyContactDesc")}</p>

        <div className="flex justify-center">
          {/* Email */}
          <div className="flex items-center gap-4 bg-white rounded-2xl p-6 hover:shadow-lg transition cursor-pointer w-full max-w-md">
            ...
            <div className="text-left min-w-0">
              ...
              <a
                ...
                className="text-gray-900 font-semibold hover:text-[#FF7EB3] transition wrap-break-words"
              >
                contact@deligo.pt
              </a>
            </div>
