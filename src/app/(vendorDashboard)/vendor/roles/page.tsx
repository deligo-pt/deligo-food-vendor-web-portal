// Vendor Roles & Permissions — Ultra Premium Glovo‑Style
// Next.js + TypeScript + Tailwind + shadcn
// File: app/vendor/roles-permissions/page.tsx
...
const ROLES = ["Manager", "Chef", "Staff", "Viewer"];
            ...
            >
              <Card className="rounded-3xl bg-white border shadow-md hover:shadow-xl transition-all" style={{ boxShadow: SHADOW }}>
                <CardContent className="p-6 space-y-5">
                  ...
                  <Button className="w-full text-white mt-4" style={{ background: PRIMARY }}>
                    Save Changes
                  </Button>
                </CardContent>
              </Card>
