  ...
  return (
    <div className="min-h-screen p-6 space-y-10">
      ...
      <TitleHeader
        ...
        subtitle={t("real_time_ingredient_alerts_based_on_order")}
      />
        ...
        <CardContent className="p-6 flex items-center gap-4">
          ...
          <div>
            <p className="font-semibold text-gray-800">
              {t("live_monitoring_enabled")}
            </p>
            <p className="text-sm text-gray-500">
              {t("tracking_orders_consumption_real_time")}
            </p>
          </div>
        </CardContent>
      </Card>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      {t("used_today")}: {alert.usedToday} {t("units")}
                    </p>

                    <div className="mt-2">
                      {alert.level === "critical" && (
                        <Badge className="bg-red-100 text-red-700 flex gap-1">
                          <AlertTriangle size={14} /> {t("critical")} —{" "}
                          {t("out_of_stock")}
                        </Badge>
                      )}
                      {alert.level === "low" && (
