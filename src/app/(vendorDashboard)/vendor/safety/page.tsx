      ...
      <div className="max-w-[900px] mx-auto space-y-10">
          ...
          <Card className="rounded-3xl bg-white border shadow-md" style={{ boxShadow: SHADOW }}>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-lg" style={{ color: PRIMARY }}>{t("food_handling_policies")}</h2>
              </div>
          ...
          <Card className="rounded-3xl bg-white border shadow-md" style={{ boxShadow: SHADOW }}>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-lg" style={{ color: PRIMARY }}>{t("staff_safety_training")}</h2>
              </div>
              <ul className="text-sm text-gray-700 space-y-2 ml-2">
          ...
          <Card className="rounded-3xl bg-white border shadow-md" style={{ boxShadow: SHADOW }}>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-lg" style={{ color: PRIMARY }}>{t("data_privacy_security")}</h2>
              </div>
              <ul className="text-sm text-gray-700 space-y-2 ml-2">
          ...
          <Card className="rounded-3xl bg-white border shadow-md" style={{ boxShadow: SHADOW }}>
            <CardContent className="p-6 space-y-4">
              <div className="flex items-center gap-3">
                ...
                <h2 className="font-bold text-lg" style={{ color: PRIMARY }}>{t("delivery_safety")}</h2>
              </div>
              <ul className="text-sm text-gray-700 space-y-2 ml-2">
        ...
        <Card className="rounded-3xl bg-white border shadow-md" style={{ boxShadow: SHADOW }}>
          <CardContent className="p-6 text-center space-y-3">
            <HandHeart size={40} className="mx-auto text-pink-600" />
            <h2 className="font-bold text-xl">{t("need_help_safety_compliance")}</h2>
