          ...
          <CardContent className="p-6">
            ...
            <div className="flex items-end gap-4 h-48">
              {DAILY_EARNINGS.map((d) => {
                const height = Math.round((d.value / maxValue) * BAR_MAX_HEIGHT);
                return (
...
/* ---------------------------
   Metric component
----------------------------*/
function Metric({ label, value, tone = "gray" }: { label: string; value: string | number; tone?: "green" | "red" | "pink" | "gray" }) {
  const colorClass =
    tone === "green" ? "text-green-600" : tone === "red" ? "text-red-600" : tone === "pink" ? "text-pink-600" : "text-gray-800";
