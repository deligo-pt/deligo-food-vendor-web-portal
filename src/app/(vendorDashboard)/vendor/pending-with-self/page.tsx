...
const PendingWithSelfPickupOrdersPage = async ({ searchParams }: IProps) => {
    ...
    return (
        <Orders
            ...
            title="pending_with_self_pickup"
            subtitle="list_of_all_pending_orders_with_self_pickup"
        />
    );
}


export default PendingWithSelfPickupOrdersPage;