  ...
  return (
    <div className="min-h-screen p-6 md:p-10" style={{ background: BG }}>
      <div className="max-w-[1100px] mx-auto space-y-10">
        ...
        {filtered.length === 0 && (
          <p className="text-center text-gray-500 py-10">No ingredients found.</p>
        )}
        ...
        <Card className="rounded-3xl bg-white border shadow-md">
          <CardContent className="p-6 space-y-3">
            ...
            <ul className="list-disc pl-5 text-sm text-gray-700 space-y-2">
              <li>Tomatoes and Mozzarella Cheese expected to run out today.</li>
              <li>Chicken is the most used ingredient — keep backup stock.</li>
              <li>Burger buns out of stock — affects 4 top-selling items.</li>
              <li>Increasing salad sales — ensure lettuce freshness.</li>
            </ul>
