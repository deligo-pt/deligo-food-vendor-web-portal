        ...
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-4xl font-extrabold" style={{ color: PRIMARY }}>
              {t("tax_report_iva_breakdown")}
            </h1>
            <p className="text-sm text-gray-600 mt-1">
              {t("portugal_compliant_iva_calculation")}
            </p>
          </div>

          <Button className="flex items-center gap-2 text-white" style={{ background: PRIMARY }}>
            <Download size={18} /> {t("export_tax_report")}
          </Button>
        </div>
        ...
        <Card className="rounded-3xl bg-white border shadow-md">
          <CardContent className="p-6 space-y-4">
            ...
            <ul className="text-sm text-gray-700 space-y-2">
              <li>• {t("vendor_collects_revenue")} <strong>{t("iva_6_perc")}</strong> {t("on_food_sales")}</li>
              <li>• {t("platform_commission_has")} <strong>{t("iva_23_perc")}</strong> {t("portugal_law")}.</li>
